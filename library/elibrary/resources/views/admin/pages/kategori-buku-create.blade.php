...
<!-- page content -->
        <div class="right_col" role="main">
          	<div class="row">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Kategori Buku<small>Tambah kategori buku</small></h2>
                    ...
                    <div class="form-group row">
                    	<div class="col-md-6">
                      		<label for="fullname">Nama Kategori <span class="required">*</span> :</label>
                      		<input type="text" id="fullname" class="form-control form-control-sm" name="fullname" required placeholder="nama kategori buku" />
						</div>
					</div>
...
<script>
	...
	$('#kembali').click(function(e) {
        window.location.href='{{url("cpanel/kategori-buku")}}';
    });
	$('#simpan').click(function(){
		if($('#fullname').val()=='') {
			...
			$.ajax({
            	url:'{{url("cpanel/kategori-buku/post")}}',
				type:'POST',
				data:formData,
