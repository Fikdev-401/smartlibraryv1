...
<html>
<head>
	<title>Daftar Peminjaman Buku Perpusatakaan</title>
    <style>
    		@page {
				/*size: 110mm 70mm; */
...
?>
        ...
        <caption style="font-weight:bold;"><p>DAFTAR PEMINJAMAN BUKU PERPUSTAKAAN<br> TAHUN &nbsp;
        <?=$id1?></p></caption>
        <thead>
        	<tr>
            	<th width="4%">No.</th>
        ...
        <tbody>
        	...
        	<tr>
                ...
                <td style="vertical-align:top; text-align:center">{{$rData->status}}</td>
