...
-- Dumping database structure for lj_elibrary
CREATE DATABASE IF NOT EXISTS `lj_elibrary` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `lj_elibrary`;
...
-- Dumping data for table lj_elibrary.elib_banner: ~2 rows (approximately)
...
-- Dumping data for table lj_elibrary.elib_buku_hilang: ~0 rows (approximately)
...
-- Dumping data for table lj_elibrary.elib_identitas: ~0 rows (approximately)
...
-- Dumping data for table lj_elibrary.elib_jenis_buku: ~11 rows (approximately)
...
-- Dumping data for table lj_elibrary.elib_rak: ~11 rows (approximately)
...
-- Dumping data for table lj_elibrary.users: ~0 rows (approximately)
DELETE FROM `users`;
