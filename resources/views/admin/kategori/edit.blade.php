...
<div class="pcoded-content">
        ...
        <div class="row">            
            <div class="col-xl-12 col-md-12">
                <!-- start datatable-->
                <div class="card">
                    <form action="{{route('gen.kategori.update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="iddata" value="{{$data->id_kategori}}">
                    <div class="card-body">
                        <div class="form-group" style="margin-bottom: 0px">
                            <label>Nama Kategori<span class="text-danger">*</span></label>
                            <input type="text" id="nama" name="nama" placeholder="Masukkan nama kategori ebook" class="form-control form-control-sm" required="" value="{{$data->nama_kat}}">
                        </div>
                    </div>
