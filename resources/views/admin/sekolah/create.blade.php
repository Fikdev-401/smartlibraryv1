...
<div class="pcoded-content">
            ...
            <div class="page-block">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        ...
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">Tambah Nama Sekolah Smart Library</li>
                        </ul>
                    </div>
        ...
        <div class="row">            
            <div class="col-xl-12 col-md-12">
                <!-- start datatable-->
                <div class="card">
                    <form action="{{route('sekolah.post')}}" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="card-body">
                        <div class="form-group" style="margin-bottom: 0px">
                            <label>Nama Sekolah<span class="text-danger">*</span></label>
                            <input type="text" id="nama" name="nama" placeholder="Masukkan nama sekolah" class="form-control form-control-sm" required="" value="{{old('nama')}}">
                        </div>
                    </div>
