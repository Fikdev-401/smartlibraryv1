<meta charset="utf-8">
    ...
    <link rel="icon" href="{{asset('portal/img/pavicon.png')}}" type="image/png" sizes="16x16">
    ...
    <link rel="stylesheet" href="{{asset('admin/assets/jquery-toast/jquery.toast.min.css')}}">